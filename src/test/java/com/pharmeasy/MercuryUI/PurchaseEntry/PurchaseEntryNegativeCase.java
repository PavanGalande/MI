...
public class PurchaseEntryNegativeCase extends TestBase {
	...
	public void NegativePurchaseEntry(String invNum, String medName, String test) throws InterruptedException
	{
		...
		//gp.clicknext1();
		Thread.sleep(2000);
		pe.NegativePurchaseEntry(invNum, medName);
